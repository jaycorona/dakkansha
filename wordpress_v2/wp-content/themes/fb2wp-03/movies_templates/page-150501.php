...
function add_amo_script() {
	wp_register_script('amo_js', plugin_dir_url('/home/pinotter/dakkansha.jp/public_html/site/wp-content/plugins/auto_make_movie_page/auto_make_movie_page.php').'/js/index.js');
	wp_enqueue_script('amo_js');
}
add_action('wp_print_styles', 'add_amo_stylesheet');
function add_amo_stylesheet() {
	wp_register_style('amo_css', plugin_dir_url('/home/pinotter/dakkansha.jp/public_html/site/wp-content/plugins/auto_make_movie_page/auto_make_movie_page.php') . '/css/index.css');
